...
<form class="form-horizontal" method="POST" action="{{route('visitantes.insert')}}">
        @csrf
<fieldset>
<div class="card ">
    <div class="card-header text-white bg-primary mb-3">Cadastro de visitantes</div>
...
<div class="col-md-2">
  ...
  <input id="dtvisita" name="dtvisita" placeholder="DD/MM/AAAA" class="form-control input-md" required="" type="date" maxlength="10" OnKeyPress="formatar('##/##/####', this)" onBlur="showhide()">
</div>
